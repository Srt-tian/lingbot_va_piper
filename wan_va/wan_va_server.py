...
class VA_Server:
    ...
    def __init__(self, job_config):
        ...
        transformer_root = os.path.join(job_config.wan22_pretrained_model_name_or_path, 'transformer')
        if hasattr(job_config, 'resume_from') and job_config.resume_from:
            transformer_root = os.path.join(job_config.resume_from, 'transformer')
